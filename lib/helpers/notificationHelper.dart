...
Future<dynamic> myBackgroundMessageHandler(Map<String, dynamic> message) async {
  if (message.containsKey('data')) {
    ...
    Platform.isAndroid
        ...
        : NotificationHelper.onDidReceiveLocalNotification(
            1,
            message["data"]["title"],
        ...
        onMessage: (Map<String, dynamic> message) async {
          ...
          Platform.isAndroid
              ...
              : onDidReceiveLocalNotification(
                  1, message["title"], message["message"], jsonEncode(message));
        },
  ...
  static Future<void> showNotification(Map<String, dynamic> message) async {
    if (Platform.isAndroid) {
      ...
      const AndroidNotificationDetails androidPlatformChannelSpecifics =
          AndroidNotificationDetails('123', 'deneme', 'deneme casino',
      ...
      await flutterLocalNotificationsPlugin.show(
          0, "ne alaka", "amk", platformChannelSpecifics,
          payload: jsonEncode(message));
    }
  }
    ...
    if (payload != null) {
      ...
      if (clicked["data"]["fromm"].toString() == "1") {
        ...
        if (await canLaunch('https://www.youtube.com/watch?v=opJLR_nbtyE')) {
          launch('https://www.youtube.com/watch?v=opJLR_nbtyE',
